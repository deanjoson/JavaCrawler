...
(
    ...
    syl_this_year  decimal(10, 2) comment '阶段收益：今年以来',
    syl_1z         decimal(10, 2) comment '阶段收益：近一周',
    syl_1y         decimal(10, 2) comment '阶段收益：近一月',
    syl_3y         decimal(10, 2) comment '阶段收益：近三月',
    syl_6y         decimal(10, 2) comment '阶段收益：近六月',
    syl_1n         decimal(10, 2) comment '阶段收益：近一年',
    syl_2n         decimal(10, 2) comment '阶段收益：近2年',
    syl_3n         decimal(10, 2) comment '阶段收益：近3年',
    syl_5n         decimal(10, 2) comment '阶段收益：近5年',
    syl_build      decimal(10, 2) comment '阶段收益：成立以来',
    sharp_1n       decimal(10, 2) comment '特色数据：近一年夏普比率',
    stddev_1n      decimal(10, 2) comment '特色数据：近一年波动率',
    maxretra_1n    decimal(10, 2) comment '特色数据：近一年最大回撤',
    dtcount_1y     int comment '特色数据：近一月定投人数',
    pv_1y          int comment '特色数据：近一月访问量',
    avghold        decimal(10, 2) comment '特色数据：用户平均持有天数',
